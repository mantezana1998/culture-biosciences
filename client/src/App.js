...
function App() {
  ...
  const updateDataFromPagination = data => setDataFromPagination(data);
  ...
  return (
    <>
      <h1>Foam Take Home Challenge</h1>
        ...
        <Card image='https://i.imgur.com/WsX89jL.jpg' />
        <Buttons />

      <Pagination 
        data={data}
        setData={updateDataFromPagination}
        cardsPerPage={picturesPerPage} 
        />
    </>
  );
}
